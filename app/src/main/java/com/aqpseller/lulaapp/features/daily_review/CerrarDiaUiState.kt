...
data class CerrarDiaUiState(
    ...
    /** Si hoy ya se había cerrado antes, las respuestas que había — para no partir en blanco y
     * borrarlas sin querer al volver a entrar (bug reportado, ver `08-decisiones-tecnicas.md`). */
